...
<div class="wrapper">
	...
	<table>
		...
		<tr>
			...
			<td class="right"><asp:Label ID="Label_orgTrdNo" runat="server" /></td>
		</tr>
		<tr>
			<td class="left">cnclAmt[취소금액]</td>
			<td class="right"><asp:Label ID="Label_cnclAmt" runat="server" /></td>
		</tr>
		<tr>
			<td class="left">cardCnclAmt[신용카드취소금액]</td>
			<td class="right"><asp:Label ID="Label_cardCnclAmt" runat="server" /></td>
		</tr>
		<tr>
			<td class="left">pntCnclAmt[포인트취소금액]</td>
			<td class="right"><asp:Label ID="Label_pntCnclAmt" runat="server" /></td>
		</tr>
        <tr>
			<td class="left">coupCnclAmt[쿠폰취소금액]</td>
			<td class="right"><asp:Label ID="Label_coupCnclAmt" runat="server" /></td>
		</tr>
		<tr>
			<td class="left">blcAmt[취소가능잔액]</td> 
			<td class="right"><asp:Label ID="Label_blcAmt" runat="server" /></td>
		</tr>
        <tr>
			<td class="left">acntType[계좌구분]</td>
			<td class="right"><asp:Label ID="Label_acntType" runat="server" /></td>
		</tr>
		<tr>
			<td class="left">vAcntNo[가상계좌번호]</td>
			<td class="right"><asp:Label ID="Label_vAcntNo" runat="server" /></td>
		</tr>
        <tr>
			<td class="left">rfdPsblCd[환불가능여부]</td>
			<td class="right"><asp:Label ID="Label_rfdPsblCd" runat="server" /></td>
		</tr>
		<tr>
			<td colspan="2" style="text-align: center;"><input class="button" type="button" name="button" value="돌아가기" onclick="location.href='cancel_form.aspx'"></td>
		</tr>
	</table>
</div>
</body>
