...
<% 
    ...
    String PG_MID = util.PG_MID; //상점아이디
    String PAYMENT_SERVER = util.PAYMENT_SERVER; //결제 서버URL
%>
<!DOCTYPE html>
<html>
<head>
...
function autoPay(){
    init('mobileAuto');
    $('#STPG_payForm2').attr("action", "pay_autoPayResult.aspx");
...
/** pay_receiveResult.aspx로부터 응답 값을 받아와서 main폼에 세팅 */
...
/** main폼에 세팅된 응답 값 출력 */
function goResult(){
    $('#STPG_payForm').attr("action", "pay_showResult.aspx");
...
<body>
<button onclick="location.href='pay_form.aspx'">결제 샘플로</button>
<button onclick="location.href='cancel_form.aspx'">취소 샘플로</button>
<div class="wrapper">  
